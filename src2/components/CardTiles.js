        ...
        <Row>
            <Col height={screenWidth / 3 - 10}>
              ...
              <Card
                    ...
                    containerStyle={{borderRadius: 30, margin: 2, flex: 1}}
                >
                  <LinearGradient colors={[COLORS.primary, COLORS.secondary]} style={{  height: 50, width: 50, borderRadius: 40, justifyContent:'center', alignItems:'center'}}>
            ...
            </Col>
            {
                ...
                <Col height={screenWidth / 3 - 10}>
                  ...
                  <Card wrapperStyle={{alignItems:'center'}} containerStyle={{borderRadius: 30, margin: 2, flex: 1}}>
                    <LinearGradient colors={[COLORS.primary, COLORS.secondary]} style={{height: 50, width: 50, borderRadius: 40,justifyContent:'center', alignItems:'center'}}>
